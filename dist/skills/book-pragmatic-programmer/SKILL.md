...
description: Use as a general engineering operating style when the goal is accountable delivery, adaptability, fast feedback, and code that remains easy to change. Do NOT use for unrelated work, and never load a second book-* skill in the same task.
---

# Pragmatic programming

> Distilled from *The Pragmatic Programmer by Hunt and Thomas*. MIT-licensed ruleset vendored from
...
- **`any more specific book-* skill`** — This one loses. It is a tiebreaker, not a tie.
